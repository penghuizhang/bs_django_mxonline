# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2018-04-29 21:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('TeacherName', models.CharField(max_length=20, verbose_name='教师名')),
                ('CourseName', models.CharField(max_length=100, verbose_name='发布课程名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_url', models.CharField(default='', max_length=150, verbose_name='微信获取头像')),
                ('userAccount', models.CharField(default='', max_length=50, verbose_name='用户账号')),
            ],
            options={
                'verbose_name': '用户信息',
